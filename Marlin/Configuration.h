...
#define STRING_CONFIG_H_AUTHOR "(SCCMOG, Ender-3 v2)" // Who made the changes.
...
#define ENDSTOP_INTERRUPTS_FEATURE //check richie
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 142.4 }
